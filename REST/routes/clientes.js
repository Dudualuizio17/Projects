...
router.post('/client', (req, res, next) => {
    mysql.getConnection((error, conn) => {
        if (error) { return res.status(500).send({ error: error }) }
        conn.query(
            'INSERT INTO client (name_cli, surname_cli, fone1_cli, fone2_cli, adress_cli, cep_cli, createdate_cli, status_cli ) VALUES (?,?,?,?,?,?,?,?)',
           [req.body.name_cli, req.body.surname_cli, req.body.fone1_cli, req.body.fone2_cli, req.body.adress_cli, req.body.cep_cli, req.body.createdate_cli, req.body.status_cli],
