...
router.post('/product', (req, res, next) => {
    mysql.getConnection((error, conn) => {
        if (error) { return res.status(500).send({ error: error }) }
        conn.query(
            'INSERT INTO product (description_pdt, stock_control_pdt, stock_min_pdt, creation_date_pdt, status_pdt, price_pdt ) VALUES (?,?,?,?,?,?)',
           [req.body.description_pdt, req.body.stock_control_pdt, req.body.stock_min_pdt, req.body.creation_date_pdt, req.body.status_pdt, req.body.price_pdt ],
