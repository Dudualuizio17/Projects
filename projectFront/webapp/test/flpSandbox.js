		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Betel Gas",
									"targetURL": "#projectbetelgas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectbetelgas-display": {
								"semanticObject": "projectbetelgas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectbetelgas",
									"url": sap.ui.require.toUrl("projectbetelgas")
								}
							}
						}
					}
